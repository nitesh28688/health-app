...
Respond with realistic values. Treat beverages (including alcohol and liquor) as food. If the query is not a consumable food or beverage, set "is_food" to false.
