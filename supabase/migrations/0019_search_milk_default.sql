-- 0019_search_milk_default.sql — boost whole milk over buttermilk etc.
--
-- Adds one more tier to search_foods() ahead of the generic-entry boost from 0018,
-- specifically for plain "milk" searches, so "Milk, whole..." outranks "Milk, buttermilk..."
