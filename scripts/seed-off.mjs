...
// Three-tier heuristic, kept in sync with seed-off-bulk.mjs (see comments there for
// the false-positive history: "milk" flagging cheese slices, the drink brand "Slice"
// matching "Cheese Slices", "butter" vetoing buttermilk).
